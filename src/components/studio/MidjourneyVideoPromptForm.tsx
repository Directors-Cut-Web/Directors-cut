...
export default function KlingPromptForm({ onPromptGenerated }: { onPromptGenerated: (prompt: string) => void; }) {
  ...
  return (
    <>
      <Alert><Lightbulb className="w-5 h-5" /><AlertTitle>How Kling Works</AlertTitle><AlertDescription>Kling creates high-fidelity, long-duration videos with a sophisticated understanding of real-world physics and complex motion.</AlertDescription></Alert>
      <div className="mt-6">
        <StudioLayout
